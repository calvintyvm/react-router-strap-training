...
class Home extends Component {
  ...
  render() {
    ...
    const Button = styled.button`
      ...
      margin: 0 1em;
      margin-top: 3em
      background: ${this.state.showOther == true ? "black" : "white"}
      color: ${this.state.showOther !== true ? "black" : "white"};
  ...
  `;
    ...
    return (
      <div class="main-container">
        ...
        <Media>
          <Media.Left>
            {this.state.showOther == false ? (
              ...
              <Carousel className="carousel-fade">
                <Carousel.Item>
                  <img className="image1" src={droneImage4} alt="thumbnail" />
                  <Carousel.Caption />
                </Carousel.Item>
                <Carousel.Item>
                  <img className="image1" src={droneImage5} alt="thumbnail" />
                  <Carousel.Caption />
                </Carousel.Item>
                <Carousel.Item>
                  <img className="image1" src={droneImage6} alt="thumbnail" />
                  <Carousel.Caption />
                </Carousel.Item>
              </Carousel>
            )}
          ...
          <div className="image1-body">
            <Media.Body>
              ...
              <Row className="show-grid">
                ...
                <Button onClick={this.showTrue}>Black</Button>
                <ButtonFalse onClick={this.showFalse}>White</ButtonFalse>
              </Row>
            </Media.Body>
          </div>
        </Media>
        ...
        <div className="part3">
          <h1 className="part2-center">Our Trusted Stats.</h1>
